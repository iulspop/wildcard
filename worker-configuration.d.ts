/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c78f800f63ba88b04cd63b8156246a55)
// Runtime types generated with workerd@1.20260730.1 2026-07-24 nodejs_compat
interface __BaseEnv_Env {
  AUTH_DB: D1Database;
  ASSETS: Fetcher;
  TEMPORARY_ROOM_TTL_MS: "3600000";
  SESSION_SECRET: string;
  PASSKEY_RP_ID: string;
  PASSKEY_RP_NAME: string;
  PASSKEY_ORIGIN: string;
  GAME_ROOMS: DurableObjectNamespace<import("./worker").GameRoom>;
}
